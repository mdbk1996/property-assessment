...
export function CompareTab({ state, calc }) {
  ...
  return (
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '20px' }}>
      {/* Flip */}
      <div>
        <div style={{ fontSize: '14px', color: '#9a6e0c', fontFamily: "'Cormorant Garamond', serif", fontWeight: 600, marginBottom: '14px', textTransform: 'uppercase', letterSpacing: '0.06em' }}>🔨 Flip</div>
      ...
      {/* Hold */}
      <div>
        <div style={{ fontSize: '14px', color: '#9a6e0c', fontFamily: "'Cormorant Garamond', serif", fontWeight: 600, marginBottom: '14px', textTransform: 'uppercase', letterSpacing: '0.06em' }}>📈 Hold</div>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
      ...
      {/* BRRRR */}
      <div>
        <div style={{ fontSize: '14px', color: '#9a6e0c', fontFamily: "'Cormorant Garamond', serif", fontWeight: 600, marginBottom: '14px', textTransform: 'uppercase', letterSpacing: '0.06em' }}>♻️ BRRRR</div>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
          <MetricCard
